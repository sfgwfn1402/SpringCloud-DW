package com.dwcloud.auth.cloud.gateway.service.impl;
...
public class InitService {
    ...
    @PostConstruct
    public void init() {
        redisTemplate.opsForHash().put(SysConstant.OAUTH_URLS, "/order/login/info", Lists.newArrayList("ROLE_admin", "ROLE_user", "ROLE_GUEST"));
