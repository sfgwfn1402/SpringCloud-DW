package com.dwcloud.auth.cloud.gateway.filter;
...
import com.dwcloud.auth.cloud.common.model.TokenConstant;
...
public class GlobalAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        try {
            //4. 解析token（解析令牌中的用户信息），使用tokenStore
            ...
            //6. 将解析后的token加密放入请求头中，方便下游微服务解析获取用户信息
