...
import com.dwcloud.auth.resource.exception.OAuthServerAuthenticationEntryPoint;
import com.dwcloud.auth.resource.exception.OAuthServerWebResponseExceptionTranslator;
import com.dwcloud.auth.resource.filter.OAuthServerClientCredentialsTokenEndpointFilter;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    /**
     * 令牌管理服务的配置
     * 可以配置令牌相关的内容，比如token的存储、过期时间、token的增强等等
     * 这里使用DefaultTokenServices，默认的令牌管理服务，可以直接使用
     */
    @Bean
